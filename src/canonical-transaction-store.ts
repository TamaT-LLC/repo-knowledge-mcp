...
import {
  ...
  type ExistingRecord,
  type ManifestAppendRecord,
  type ManifestFileWrite,
  type ManifestPrecondition,
} from "./canonical-transaction-manifest.js";
import {
...
export { CanonicalStoreError };
export type { CanonicalStoreErrorCode } from "./canonical-path-validation.js";
