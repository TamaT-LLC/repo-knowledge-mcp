// This compatibility barrel is intentionally outside the stable package root.
// See docs/operations/node-api.md before adding or consuming an export here.
export {
...
export {
  ...
  PilotRecordError,
  PilotStatsSnapshotSchema,
  PilotSyncSummaryLineSchema,
  UtcDaySchema,
  buildMissingDailyRecord,
  buildObservedDailyRecord,
  listPilotWindowDates,
  parsePilotLog,
  type BuildMissingDailyRecordRequest,
  type BuildObservedDailyRecordRequest,
  type MissingPilotDailyRecord,
...
export {
  ...
  type PilotSummaryQuality,
  type PilotSummaryReport,
  type PilotSummarySync,
  type PilotSummaryWindow,
  type SummarizePilotLogRequest,
} from "./pilot-summary.js";
export {
  PILOT_HUMAN_RUBRIC_KIND,
  PILOT_RUBRIC_EVALUATION_KIND,
...
export {
  ...
  type KnowledgeReadSyncCheckpointReader,
