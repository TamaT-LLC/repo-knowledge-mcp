...
| M3-FR-008 npm 配布 | [bootstrap package builder](../../scripts/build-bootstrap-package.mjs) のinert package closure、[artifact gate](../../scripts/package-artifact-gate.mjs)、[package smoke](../../scripts/package-smoke.mjs)、[release gate](../../scripts/release-gate.mjs) のversion、commit、visibility、license、scoped package名のfail-closed検査、[release workflow](../../.github/workflows/release.yml) のtraditional credential拒否とOIDC publish、[registry smoke](../../scripts/registry-smoke.mjs)、[npm公開方式セキュリティレビュー](../operations/m3-npm-release-security-review-2026-08-24.md)、[npm release runbook](../operations/npm-release-runbook.md) | automated + Release CI + operational bootstrap |
