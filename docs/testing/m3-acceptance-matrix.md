...
| M3-FR-002 Guided setup | [setup service test](../../test/setup-service.test.ts)、[CLI runtime test](../../test/cli-runtime.test.ts)、[package smoke](../../scripts/package-smoke.mjs) | automated + package gate |
